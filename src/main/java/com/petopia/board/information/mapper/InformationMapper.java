...
public interface InformationMapper {
	...
	@Select("SELECT info_seq, info_subject, info_content, info_rep_img_path, info_dt, m.m_seq, info_hit, info_cmt_cnt, info_rec_cnt, m_nickname FROM information a INNER JOIN member m ON a.m_seq = m.m_seq ORDER BY info_dt DESC LIMIT 6;")
