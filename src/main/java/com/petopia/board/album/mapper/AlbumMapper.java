...
public interface AlbumMapper {
	...
	@Select("SELECT ab_seq, ab_subject, ab_content, ab_dt, ab_rep_img_path, m.m_seq, ab_hit, ab_cmt_cnt, ab_rec_cnt, m_nickname FROM album a INNER JOIN member m ON a.m_seq = m.m_seq ORDER BY ab_dt DESC, ab_seq DESC LIMIT 9")
